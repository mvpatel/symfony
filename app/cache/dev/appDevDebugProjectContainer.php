...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'J:/wamp/www/symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'J:/wamp/www/symfony/app/cache/dev',
            'kernel.logs_dir' => 'J:/wamp/www/symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'trrsywxBundle' => 'tr\\rsywxBundle\\trrsywxBundle',
                'AcmeClientBundle' => 'Acme\\ClientBundle\\AcmeClientBundle',
                'AcmeAgentBundle' => 'Acme\\AgentBundle\\AcmeAgentBundle',
            ...
            'database_user' => 'user_symfony',
            'database_password' => 'pass_symfony',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'a298be24434e10ddb6701fb2ff781a25b',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => 'a298be24434e10ddb6701fb2ff781a25b',
            ...
            'session.save_path' => 'J:/wamp/www/symfony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:J:/wamp/www/symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'J:/wamp/www/symfony/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'J:/wamp/www/symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'J:/wamp/www/symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'J:/wamp/www/symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'J:/wamp/www/symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'J:/wamp/www/symfony/app/../web',
            'assetic.write_to' => 'J:/wamp/www/symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'J:/wamp/www/symfony/app/cache/dev/doctrine/orm/Proxies',
    ...
    {
        return $this->services['acme_user.registration.form.type'] = new \Acme\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'J:/wamp/www/symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('J:/wamp/www/symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'J:/wamp/www/symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'J:/wamp/www/symfony/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'user_symfony', 'password' => 'pass_symfony', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\UserBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AccountBundle\\Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\TaskBundle\\Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AgentBundle\\Entity')));

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'\\src\\tr\\rsywxBundle\\Resources\\config\\doctrine') => 'tr\\rsywxBundle\\Entity', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\ClientBundle\\Resources\\config\\doctrine') => 'Acme\\ClientBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $e->addDriver($b, 'FOS\\UserBundle\\Entity');
        $e->addDriver($c, 'Acme\\UserBundle\\Entity');
        $e->addDriver($c, 'Acme\\AccountBundle\\Entity');
        $e->addDriver($c, 'Acme\\TaskBundle\\Entity');
        $e->addDriver($c, 'Acme\\AgentBundle\\Entity');
        $e->addDriver($d, 'tr\\rsywxBundle\\Entity');
        $e->addDriver($d, 'Acme\\ClientBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'AcmeUserBundle' => 'Acme\\UserBundle\\Entity', 'AcmeAccountBundle' => 'Acme\\AccountBundle\\Entity', 'AcmeTaskBundle' => 'Acme\\TaskBundle\\Entity', 'trrsywxBundle' => 'tr\\rsywxBundle\\Entity', 'AcmeClientBundle' => 'Acme\\ClientBundle\\Entity', 'AcmeAgentBundle' => 'Acme\\AgentBundle\\Entity'));
        ...
        $f->setProxyDir('J:/wamp/www/symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_957689f7729f76e6123e8d7b6aea53f8afd13945184889915c9d20da31e8e685');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'J:/wamp/www/symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('J:/wamp/www/symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:J:/wamp/www/symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'J:/wamp/www/symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'J:/wamp/www/symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('J:/wamp/www/symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('J:/wamp/www/symfony/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('J:/wamp/www/symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'J:/wamp/www/symfony/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'J:/wamp/www/symfony/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AccountBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\TaskBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\ClientBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AgentBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'J:/wamp/www/symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('J:/wamp/www/symfony/app/Resources/FOSUserBundle/views', 'FOSUser');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\UserBundle/Resources/views'), 'AcmeUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AccountBundle/Resources/views'), 'AcmeAccount');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\AppBundle/Resources/views'), 'App');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\TaskBundle/Resources/views'), 'AcmeTask');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\tr\\rsywxBundle/Resources/views'), 'trrsywx');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\ClientBundle/Resources/views'), 'AcmeClient');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Acme\\AgentBundle/Resources/views'), 'AcmeAgent');
        ...
        $instance->addPath('J:/wamp/www/symfony/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a298be24434e10ddb6701fb2ff781a25b');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'J:/wamp/www/symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('J:/wamp/www/symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'J:/wamp/www/symfony/app/cache/dev');
    }
